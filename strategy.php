<?php $title="Strategy - Token Sayari"; include_once 'components/header.php';?>
    <!-- Main Content -->
                ...
                <div class="row flex-row-reverse">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="iq-feature2 iq-mb-20" style="width: 100%;">
                                ...
                                <p class="fs-6">Planet Sayari plans to partner with major banks to provide liquidity to investors through
                                    ...
                                    challenges with cryptocurrencies and security tokens which is lack of liquidity. </p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            <div class="me-3">
                    ...
                    <div class="col-lg-4 col-md-12" style="border-radius: 30px; background: rgba(255, 255, 255, 0.20);      box-shadow: 0px 3px 4px 0px rgba(0, 33, 69, 0.05), 0px -3px 4px 0px rgba(0, 33, 69, 0.05); padding: 3rem">
                        ...
                        <p>Planet Sayari’s approach takes a prudent, risk-averse stance within the volatile crypto industry,
                            seeking to provide investors with compounding value over time rather than major speculative gains.
                            The goal is stable and consistent returns through security token dividends, interest payments and
                            potential appreciation rather than rapid but unsustainable growth. Planet Sayari views its security
                            tokens as a way to bridge traditional finance and cryptocurrency, bringing the best of both worlds
                            to investors.This strategy, focusing on stability, liquidity, ecosystem and yield, aims to set
                            Planet Sayari apart within the crypto industry.</p>
