<?php $page = "about";
$active = 'mission';
$title = "Our Mission - Planet Sayari";
$current_page_url="https://www.planetsayari.com/mission";
...
<div class="main-content" onmousedown="return false" onselectstart="return false">
    ...
    <section class="overview-block-ptb7 iq-bg text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2 mb-5 head_top_Banner_res">
                    <div class="program py-4 head_top_Sub_Banner_res">
