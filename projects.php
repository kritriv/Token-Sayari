<?php $page = 'portfolio';
$active = 'projects';
$title = "Our Project - Planet Sayari";
$current_page_url="https://www.planetsayari.com/projects";
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="heading-title iq-mb-0">
                    ...
                    <p class="">These are the projects currently being carried out by Plantet Sayari:</p>
