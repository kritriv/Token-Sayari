<!--=================================
Footer -->
<footer class="iq-footer-3 bg-primary pt-5">
    <div class="footer-top iq-pb-60">
        <div class="container">
            <div class="row text-white">   
                <div class="col-lg-5 col-md-12">                
                    <img class="img-fluid mx-auto d-block iq-mt-10" src="images/app/iPhone 13 Pro.png" alt="icon1">
                </div> 
                ...
                <div class="col-lg-6 col-md-12 about-box  align-self-center" >
                    <h3 class="text-white">Planet Sayari</h3>
                    <blockquote class="iq-mt-8  font-weight-bold">The Next Frontier of Loyalty:How Blockchain MakesRewards Better with PlanetSayari.</blockquote>
                    <a class="button btn-secondary" href="javascript:void(0)">
                        <span class="button-inner-box">
                            ...
                            <span class="text-btn text-btn-new">Join our Loyalty Program</span>
                    ...
                    <p class="iq-mt-10 font-weight-bold">IDownload our Sayari mobile app and start shopping at our partner stores. Earn significant discounts on Sayt tokens. Recommend the program to others and you will earn more tokens. Exceed your monthly shopping level and you will be rewarded with even more tokens!</p>
