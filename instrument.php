<?php $active="instrument"; $page = 'protfolio'; $title="Instrument - Token Sayari"; include_once 'components/header.php';?>
<!-- Main Content -->
    ...
    <section class="overview-block-ptb grey-bg">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-lg-3 mb-5">
               <div class="col">
                  <div class="iq-feature5 rounded" style="height: 580px;">
                     ...
                     <p class="text-justify">An agreement where Planet Sayari company agrees to pay a commission to
                           sellers for promoting and selling their products. The commission can be a percentage of the
                           revenue generated from the sales. This incentivizes more sellers to list their assets on the
                           Sayari platform.</p>
               ...
               <div class="col">
                  <div class="iq-feature5 rounded"  style="height: 580px;">
                     ...
                     <p class="iq-mb-0 text-justify">Converting real-world assets like land, properties, artworks, etc. into
                           ...
                           assets and opens them up to a wider range of investors. Investors can earn returns through
                           capital gains, dividends, or other distributions.</p>
                  </div>
               </div>
               <div class="col">
                  <div class="iq-feature5 rounded"  style="height: 580px;">
               ...
               <div class="col">
                  <div class="iq-feature5 rounded"  style="height: 580px;">
                     ...
                     <p class="iq-mb-0 text-justify">An app where users can earn loyalty points and tokens by engaging with the
                           ...
                           participation and network effects.</p>
                  </div>
               </div>
               <div class="col">
                  <div class="iq-feature5 rounded"  style="height: 580px;">
                     <div class="feature7 text-center">
                           ...
                           <p class="iq-mb-0 text-justify">Allowing users to swap their Sayari tokens for other compatible tokens
                              ...
                              compatibility of the Sayari toke.</p>
                     </div>
                  </div>
               </div>
            </div>
