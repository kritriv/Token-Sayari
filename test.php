...
<head>
    ...
    <style>
        ...
        .journey_section .content_section .content_icon .NewText2 {
        ...
        .journey_section .investor_section:before {
            content: "";
            border-right: 18px solid #466ca3;
            border: 1px solid #090136;
            width: 100%;
            position: absolute;
            top: 46px;
            left: -157px;
        ...
        .journey_section .journey_content:after {
            content: "";
            /* width: 20%; */
