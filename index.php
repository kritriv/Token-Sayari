    ...
    <div class="main-content">
            ...
            <div class="container">
                <div class="row h-100">
                    <div class="col-lg-6 col-md-12 align-self-center">  
                        ...
                        <a class="button mt-4" href="javascript:void(0)">
                            <span class="button-inner-box">
                                ...
                                <span class="text-btn">Strategy</span>
                    ...
                    <div class="col-lg-6 col-md-12 text-white">
                        ...
                        <div>Planet Sayari is a revolutionary platform designed to address various issues faced by businesses and individuals in the areas of crowdfunding, trade finance, and asset tokenization. By leveraging the power of blockchain technology and combining it with innovative financial instruments, Planet Sayari offers a unique solution to help companies and projects develop and achieve their goals. Overall, Planet Sayari aims to facilitate global business opportunities, foster economic growth, and shape the future of finance.</div>
        ...
        <section class="overview-block-pb iq-team2">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            <h5 class="title iq-mb-10">Team Members</h5>
                            <h3 class="iq-mb-25 ">Our Management Team</h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-6 iq-mtb-15">
                        <div class="team-blog iq-pall-40 text-center">                            
                            ...
                            <div class="iq-font-yellow iq-mt-25 mb-5">
                                <h5 class=" "> <a href="#">Michele Cucchierato</a></h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 iq-mtb-15">
                        <div class="team-blog iq-pall-40 text-center">
                            ...
                            <div class="iq-font-yellow iq-mt-20 mb-5">
                                <h5 class=" "> <a href="#">Madalina Diana Paul</a></h5>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 iq-mtb-15">
                        <div class="team-blog iq-pall-40 text-center">
                            ...
                            <div class="iq-font-yellow iq-mt-20 mb-5">
                                <h5 class=" "> <a href="#">Dorin Axente</a></h5>
        ...
        <section id="product" class="overview-block-pb">
            <div class="container">
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-lg-2 col-md-4 col-sm-6iq-r-mt-40">
                            <div class="iq-small-icon p-2 back-bg">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="heading-title">
                            ...
                            <h3 class="iq-mb-25">Our Partners Companies</h3>
                            <!-- <p>Here is 3 Easy Steps to Busy &amp; Sell Bitcoin. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p> -->
                        </div>
                    </div>
                </div>
        ...
        <div class=" overview-block-ptb" style="background-image: url('images/home/map.svg'); background-position: center center; background-size: contain;background-repeat: no-repeat;">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-lg-2 col-md-12 text-end ">
                        <div class="d-flex align-items-center back-bg">
