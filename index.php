<?php include_once 'components/header.php';?>
            ...
            <ul>
                ...
                <li data-index="rs-14" data-transition="random-static,random-premium,random" data-slotamount="default,default,default,default" data-hideafterloop="0" data-hideslideonmobile="off" data-randomtransition="on" data-easein="default,default,default,default" data-easeout="default,default,default,default" data-masterspeed="default,default,default,default" data-thumb="revslider/assets/100x50_913ee-chart.jpg" data-rotate="0,0,0,0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption Gym-Subline   tp-resizeme" id="slide-14-layer-1" data-x="30" data-y="center" data-voffset="-100" data-width="['964']" data-height="['auto']" data-type="text" data-responsive_offset="on" data-frames='[{"delay":500,"speed":1500,"frame":"0","from":"x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;","mask":"x:0px;y:0px;s:inherit;e:inherit;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]' data-textAlign="['inherit','inherit','inherit','inherit']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]" style="z-index: 5; min-width: 964px; max-width: 964px; white-space: nowrap; font-size: 65px; line-height: 80px; font-weight: 300; color: #ffffff; letter-spacing: 0px; font-family: 'Roboto', sans-serif;  text-transform:uppercase;">the internationally
                        <br><span class="iq-font-yellow ">'cyber'</span>money. </div>
                    <!-- LAYER NR. 6 -->
    ...
    <div class="main-content">
        ...
        <section class="overview-block-ptb6 banner-stars action-box dark-bg">
            <div class="container">
                <div class="row h-100">
                    ...
                    <div class="col-lg-3 col-md-12 text-end align-self-center">  <a class="button mt-4" href="javascript:void(0)">
        ...
        <!-- Action Box -->
        <!-- How it Works -->
        <section class="overview-block-pt8 white-bg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-12">
                        <div class="iq-feature-3 iq-mt-20 grey-bg">
                    ...
                    <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="3" data-items-laptop="3" data-items-tab="2" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                        <div class="item">
                            <div class="feature-aria">
                                ...
                                <div class="feature-content grey-bg">
                        ...
                        <div class="item">
                            <div class="feature-aria">
                                ...
                                <div class="feature-content grey-bg">
                                    ...
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">Secure Stable</a></h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scram bled it to make a type specimen book.</p>
                                    <div class="read-more green"><a href="javascript:void(0)">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                                </div>
                            </div>
                        ...
                        <div class="item">
                            <div class="feature-aria">
                                ...
                                <div class="feature-content grey-bg">
                                    <h6 class="iq-font-yellow mb-2">Outstanding</h6>
                                    <h4 class="iq-font-dark mb-3"><a href="services-details.html">Free Consulting</a></h4>
                                    <p>Lorem Ipsum is simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scram bled it to make a type specimen book.</p>
                                    <div class="read-more green"><a href="javascript:void(0)">Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row h-100">
                    ...
                    <div class="col-lg-5 col-md-12 iq-mb-80 offset-xl-3">
                        ...
                        <p class="text-white iq-mt-25">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 iq-mb-80">
                        <div class="calculator white-bg iq-pall-30">
                            ...
                            <script src="../../../../www.cryptonator.com/ui/js/widget/calc_widget.html"></script>
                    ...
                    <div class="owl-carousel" data-autoplay="true" data-loop="true" data-nav="false" data-dots="true" data-items="3" data-items-laptop="3" data-items-tab="2" data-items-mobile="1" data-items-mobile-sm="1" data-margin="30">
                        <div class="item">
                            <div class="team-blog iq-pall-20 text-center">
                                ...
                                <p class="mt-2">Simply dummy text ever sincehar the 1500s, when an unknownshil printer took a galley of type and scrambled it to make a type specimen book.</p>
        ...
        <!-- Team -->
        <!-- Clients -->
        <div class="iq-our-clients iq-ptb-60 iq-bg iq-over-black-80 jarallax" style="background-image: url('images/bg/bg-13.jpg'); background-position: center center;">
            <div class="container ">
                <div class="row ">
